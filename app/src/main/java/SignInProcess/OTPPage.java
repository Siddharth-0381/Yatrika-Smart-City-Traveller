...
import ForgetPasswordProcess.newCredentialsScreen;
...
public class OTPPage extends AppCompatActivity {
    ...
    PinView pinFromUser;
    String codeBySystem;
    String name, username, email, password, gender, numberS,whatToDo;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            storeNewUsersData();
                            Intent intent = new Intent(OTPPage.this,VerifiedPage.class);
                            startActivity(intent);
                            Toast.makeText(OTPPage.this, "Verified!", Toast.LENGTH_SHORT).show();
                        } else {

                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                Toast.makeText(OTPPage.this, "Verification not completed! Please try again.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
    ...
    private void updateOldUserData() {
        Intent intent = new Intent(OTPPage.this, newCredentialsScreen.class);
    ...
    public void openLoginScreen(android.view.View view) {
        Intent intent = new Intent(OTPPage.this, LoginScreen.class);
        startActivity(intent);
        finish();
    }
